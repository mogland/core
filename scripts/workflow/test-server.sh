...
###
 ...
 # @LastEditors: Wibus
 # @LastEditTime: 2022-05-02 00:41:44
 # Coding With IU
### 
...
nohup node dist/src/main.js --DB_HOST=127.0.0.1 --DB_USERNAME=gserver --DB_PASSWORD=gasdoldedseasder --DB_DATABASE=gserver --DB_PORT=3306 --PORT=3000 1>/dev/null & # 后台运行
p=$! # 获取进程号
