/*
 * @FilePath: /nx-server/src/helper/helper.macro.service.ts
 * @author: Wibus & Innei
 * @Date: 2022-06-07 08:38:50
 * @LastEditors: Wibus
 * @LastEditTime: 2022-06-07 08:45:21
 * Coding With IU
 */
...
import { deepCloneWithFunction } from '../utils/tools.util'
...
export class TextMacroService {
  ...
  private generateFunctionContext = (variables: object) => {
    return {
      ...
      fromNow: (time: Date | string) => dayjs(time),
